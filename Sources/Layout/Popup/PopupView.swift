...
public struct Popup<PopupContent: View>: ViewModifier {
    ...
    private var displayedOffsetY: CGFloat {
        if opaqueBackground {
            ...
            if position.isBottom {
                return screenHeight - sheetContentRect.height - keyboardObserver.keyboardHeight - verticalPadding + (useSafeAreaInset ? -safeAreaInsets.bottom : 0) - safeAreaInsets.top
            }
        }
        ...
        if position.isBottom {
            return presenterContentRect.height - sheetContentRect.height - keyboardObserver.keyboardHeight + safeAreaInsets.bottom - verticalPadding + (useSafeAreaInset ? -safeAreaInsets.bottom : 0)
        }
        return 0
    }
    ...
    public func body(content: Content) -> some View {
        content
            ...
            .safeAreaModifier($safeAreaInsets)
            .overlay(
                Group {
